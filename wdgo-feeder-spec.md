---
tags: [wdgwars, feeder, spec, hmac, protocol]
created: 2026-06-02
status: verified-2026-06-02
sources:
  - "[gungnir/envelope.py](https://github.com/HiroAlleyCat/gungnir/blob/main/gungnir/envelope.py)"
  - "[gungnir/transport.py](https://github.com/HiroAlleyCat/gungnir/blob/main/gungnir/transport.py)"
  - "[gungnir/__init__.py](https://github.com/HiroAlleyCat/gungnir/blob/main/gungnir/__init__.py)"
  - "[LOCOSP/WatchDogsGo plugins/wardrive_upload.py](https://github.com/LOCOSP/WatchDogsGo/blob/main/plugins/wardrive_upload.py)"
purpose: Implementation specification for a working WDGoWars signed-JSON feeder. If someone wants to write a feeder in Rust, Go, C, or anything that can't import gungnir, this is the source-of-truth shape to match against. Verified against the two reference implementations (gungnir + WatchDogsGo plugin) — they produce byte-identical envelopes.
related:
